...
file = open('Li-H molecules-631g-200.txt', 'r').readlines()
...
def VQE_LiH_631g_fitness(qc: qiskit.QuantumCircuit) -> float:
...
env = EEnvironment(
    ...
    fitness_func=VQE_LiH_631g_fitness,
...
computation_value = vqe.general_VQE(env.best_circuit, lih_sto3g([0,0.25]), basis='631g')
print(computation_value)

# Load the result from folder
env2 = EEnvironment.load(
    './8qubits_VQE_H2_631g_fitness_2023-12-30', 
   VQE_LiH_631g_fitness
)
